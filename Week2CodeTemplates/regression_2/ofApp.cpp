...
void ofApp::setup() {
    ...
    /* set up frequency (110 - 990Hz) and resonance (4 - 9) of 1st mode */
...
void ofApp::update() {
    ...
    /* update the mode1 frequency and resonance values */
...
void ofApp::keyReleased(int key) {
    ...
    if (key == 'm' || key == 'M') {
        /* set randomisation of mode1 frequency (110 - 990Hz) and resonance (4 - 9) */
...
void ofApp::mouseDragged(int x, int y, int button) {
    ...
    /* normalize the frequency (110 - 990Hz) and resonance (4 - 9) of mode1 */
    ...
    if (isRecording && !isTrained) {
        ...
        trainingOutput = { /*add mode1 frequency and resonance variables to front of vector*/ _mode2Freq, _mode2Res, _mode3Freq, _mode3Res,_mode4Freq, _mode4Res, _mode5Freq, _mode5Res,
    ...
    if (isRunning && isTrained) {
        ...
        /* limit the output vector values to between 0 and 1 */

        /* re-map the output values to the original mode1 frequency (110 - 990Hz) and resonance (4 - 9) */
